...
from models.extended_resnet import replace_first_conv
...
def squeezenet(pretrained=True, input_ch=3):
    return SqueezeNet(pretrained)


def densenet(pretrained=True, input_ch=3):
    return DenseNet(pretrained=pretrained)


def resnet18(pretrained=True, input_ch=3):
    model = ResNet(BasicBlock, [2, 2, 2, 2])
    if pretrained:
        load_weights_sequential(model, model_zoo.load_url(model_urls['resnet18']))
    return replace_first_conv(model, input_ch=input_ch)


def resnet34(pretrained=True, input_ch=3):
...
def resnet50(pretrained=True, input_ch=3):
...
def resnet101(pretrained=True, input_ch=3):
...
def resnet152(pretrained=True, input_ch=3):
